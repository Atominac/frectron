...
class HorizonVehicleListAdapter extends RecyclerView.Adapter<HorizonVehicleListAdapter.ViewHolder>{
    private List<String> mDataSet;
    private Context mContext;
    private ReportRunningFragment fragment;


    HorizonVehicleListAdapter(Context context, List<String> list, ReportRunningFragment fragment){
        mDataSet = list;
        mContext = context;
    ...
    @Override
    public HorizonVehicleListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        // Create a new View
        View v = LayoutInflater.from(mContext).inflate(R.layout.horizontal_list,parent,false);
        return new HorizonVehicleListAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final HorizonVehicleListAdapter.ViewHolder holder, int position){
...
//        });
        ...
        holder.mRemoveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragment.runningAdapter.notifyDataSetChanged();
