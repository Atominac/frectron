...
class RunningReportListAdapter extends RecyclerView.Adapter<RunningReportListAdapter.MyViewHolder> {

    private List<RunningReportListItems> running_list;

    RunningReportListAdapter(List<RunningReportListItems> running_list) {
        this.running_list = running_list;
    }

    class MyViewHolder extends RecyclerView.ViewHolder {
        TextView vehicle_name , initial_destination,
                total_time,
                total_distance,
                final_destination,
                average_speed,
