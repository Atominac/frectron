...
public class HorizontalVehicleListAdapter  extends RecyclerView.Adapter<HorizontalVehicleListAdapter.ViewHolder>{
    ...
    public HorizontalVehicleListAdapter(Context context,List<String> list , ReportRunningFragment fragment){
        mDataSet = list;
        mContext = context;
    ...
    @Override
    public void onBindViewHolder(final HorizontalVehicleListAdapter.ViewHolder holder, int position){
